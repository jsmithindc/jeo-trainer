...
export const FLASH_DRILLS = {
  ...
  painters: {
    ...
    items: [
      { artist: 'Leonardo da Vinci', work: 'Mona Lisa', image: '/.netlify/functions/imgproxy?title=Mona_Lisa', movement: 'Renaissance', artist_prompt: 'Leonardo da Vinci (Italian Renaissance)' },
      { artist: 'Leonardo da Vinci', work: 'The Last Supper', image: '/.netlify/functions/imgproxy?title=The_Last_Supper_(Leonardo)', movement: 'Renaissance', artist_prompt: 'Leonardo da Vinci (Mona Lisa painter)' },
      { artist: 'Michelangelo', work: 'The Creation of Adam', image: '/.netlify/functions/imgproxy?title=The_Creation_of_Adam', movement: 'Renaissance', artist_prompt: 'Michelangelo (Sistine Chapel ceiling)' },
      { artist: 'Raphael', work: 'The School of Athens', image: '/.netlify/functions/imgproxy?title=The_School_of_Athens', movement: 'Renaissance', artist_prompt: 'Raphael (Italian High Renaissance)' },
      { artist: 'Sandro Botticelli', work: 'The Birth of Venus', image: '/.netlify/functions/imgproxy?title=The_Birth_of_Venus', movement: 'Renaissance', artist_prompt: 'Sandro Botticelli (Italian Renaissance)' },
      { artist: 'Rembrandt', work: 'The Night Watch', image: '/.netlify/functions/imgproxy?title=The_Night_Watch', movement: 'Dutch Golden Age', artist_prompt: 'Rembrandt van Rijn (Dutch master)' },
      { artist: 'Johannes Vermeer', work: 'Girl with a Pearl Earring', image: '/.netlify/functions/imgproxy?title=Girl_with_a_Pearl_Earring', movement: 'Dutch Golden Age', artist_prompt: 'Johannes Vermeer (Dutch, 17th c.)' },
      { artist: 'Francisco Goya', work: 'The Third of May 1808', image: '/.netlify/functions/imgproxy?title=The_Third_of_May_1808', movement: 'Romanticism', artist_prompt: 'Francisco Goya (Spanish, late 18th c.)' },
      { artist: 'Eugène Delacroix', work: 'Liberty Leading the People', image: '/.netlify/functions/imgproxy?title=Liberty_Leading_the_People', movement: 'Romanticism', artist_prompt: 'Eugène Delacroix (French Romantic)' },
      { artist: 'J.M.W. Turner', work: 'The Fighting Temeraire', image: '/.netlify/functions/imgproxy?title=The_Fighting_Temeraire', movement: 'Romanticism', artist_prompt: 'J.M.W. Turner (English landscape painter)' },
      { artist: 'Claude Monet', work: 'Water Lilies', image: '/.netlify/functions/imgproxy?title=Water_Lilies_Monet', movement: 'Impressionism', artist_prompt: 'Claude Monet (French Impressionist)' },
      { artist: 'Claude Monet', work: 'Impression, Sunrise', image: '/.netlify/functions/imgproxy?title=Impression,_Sunrise', movement: 'Impressionism', artist_prompt: 'Claude Monet (Water Lilies painter)' },
      { artist: 'Pierre-Auguste Renoir', work: 'Luncheon of the Boating Party', image: '/.netlify/functions/imgproxy?title=Luncheon_of_the_Boating_Party', movement: 'Impressionism', artist_prompt: 'Pierre-Auguste Renoir (French Impressionist)' },
      { artist: 'Edgar Degas', work: 'The Dance Class', image: '/.netlify/functions/imgproxy?title=The_Dance_Class_Degas', movement: 'Impressionism', artist_prompt: 'Edgar Degas (French, ballet paintings)' },
      { artist: 'Georges Seurat', work: 'A Sunday on La Grande Jatte', image: '/.netlify/functions/imgproxy?title=A_Sunday_on_La_Grande_Jatte', movement: 'Post-Impressionism', artist_prompt: 'Georges Seurat (Pointillism founder)' },
      { artist: 'Paul Cézanne', work: 'The Card Players', image: '/.netlify/functions/imgproxy?title=The_Card_Players_Cezanne', movement: 'Post-Impressionism', artist_prompt: 'Paul Cézanne (father of modern art)' },
      { artist: 'Paul Gauguin', work: 'Where Do We Come From?', image: '/.netlify/functions/imgproxy?title=Where_Do_We_Come_From_Gauguin', movement: 'Post-Impressionism', artist_prompt: 'Paul Gauguin (Tahitian paintings)' },
      { artist: 'Vincent van Gogh', work: 'The Starry Night', image: '/.netlify/functions/imgproxy?title=The_Starry_Night', movement: 'Post-Impressionism', artist_prompt: 'Vincent van Gogh (Dutch Post-Impressionist)' },
      { artist: 'Vincent van Gogh', work: 'Sunflowers', image: '/.netlify/functions/imgproxy?title=Sunflowers_Van_Gogh', movement: 'Post-Impressionism', artist_prompt: 'Vincent van Gogh (The Starry Night painter)' },
      { artist: 'Edvard Munch', work: 'The Scream', image: '/.netlify/functions/imgproxy?title=The_Scream', movement: 'Expressionism', artist_prompt: 'Edvard Munch (Norwegian Expressionist)' },
      { artist: 'Gustav Klimt', work: 'The Kiss', image: '/.netlify/functions/imgproxy?title=The_Kiss_(Klimt)', movement: 'Symbolism', artist_prompt: 'Gustav Klimt (Austrian, golden style)' },
      { artist: 'Pablo Picasso', work: 'Guernica', image: '/.netlify/functions/imgproxy?title=Guernica', movement: 'Cubism', artist_prompt: 'Pablo Picasso (Spanish, co-founder of Cubism)' },
      { artist: 'Pablo Picasso', work: 'Les Demoiselles d\'Avignon', image: '/.netlify/functions/imgproxy?title=Les_Demoiselles_d%27Avignon', movement: 'Cubism', artist_prompt: 'Pablo Picasso (Guernica painter)' },
      { artist: 'Henri Matisse', work: 'Dance', image: '/.netlify/functions/imgproxy?title=Dance_(Matisse)', movement: 'Fauvism', artist_prompt: 'Henri Matisse (French, bold color)' },
      { artist: 'Salvador Dalí', work: 'The Persistence of Memory', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/d/dd/The_Persistence_of_Memory.jpg', movement: 'Surrealism', artist_prompt: 'Salvador Dalí (Spanish Surrealist)' },
      { artist: 'René Magritte', work: 'The Treachery of Images', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/b/b9/MagrittePipe.jpg', movement: 'Surrealism', artist_prompt: 'René Magritte (Belgian Surrealist, pipe painting)' },
      { artist: 'Frida Kahlo', work: 'The Two Fridas', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/1/18/Frida_Kahlo_%28self_portrait%29.jpg', movement: 'Surrealism', artist_prompt: 'Frida Kahlo (Mexican, self-portraits)' },
      { artist: 'Jackson Pollock', work: 'No. 31', image: '/.netlify/functions/imgproxy?title=One:_Number_31,_1950', movement: 'Abstract Expressionism', artist_prompt: 'Jackson Pollock (drip painting technique)' },
      { artist: 'Mark Rothko', work: 'Orange and Yellow', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/2/25/Rothko_No_61.jpg', movement: 'Abstract Expressionism', artist_prompt: 'Mark Rothko (color field painting)' },
      { artist: 'Andy Warhol', work: 'Campbell\'s Soup Cans', image: '/.netlify/functions/imgproxy?title=Campbell_Soup_Cans_Warhol', movement: 'Pop Art', artist_prompt: 'Andy Warhol (American Pop Art)' },
      { artist: 'Roy Lichtenstein', work: 'Whaam!', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/5/56/Roy_Lichtenstein_Whaam.jpg', movement: 'Pop Art', artist_prompt: 'Roy Lichtenstein (comic-style Pop Art)' },
      { artist: 'Grant Wood', work: 'American Gothic', image: '/.netlify/functions/imgproxy?title=American_Gothic', movement: 'Regionalism', artist_prompt: 'Grant Wood (American Regionalism)' },
      { artist: 'Edward Hopper', work: 'Nighthawks', image: '/.netlify/functions/imgproxy?title=Nighthawks', movement: 'Realism', artist_prompt: 'Edward Hopper (American Realist)' },
      { artist: 'Jan van Eyck', work: 'The Arnolfini Portrait', image: '/.netlify/functions/imgproxy?title=Arnolfini_Portrait', movement: 'Northern Renaissance', artist_prompt: 'Jan van Eyck (Flemish, early Northern Renaissance)' },
      { artist: 'Hieronymus Bosch', work: 'The Garden of Earthly Delights', image: '/.netlify/functions/imgproxy?title=The_Garden_of_Earthly_Delights', movement: 'Northern Renaissance', artist_prompt: 'Hieronymus Bosch (Dutch, fantastical imagery)' },
      { artist: 'Pieter Bruegel the Elder', work: 'The Hunters in the Snow', image: '/.netlify/functions/imgproxy?title=The_Hunters_in_the_Snow', movement: 'Northern Renaissance', artist_prompt: 'Bruegel the Elder (Flemish, peasant scenes)' },
      { artist: 'Albrecht Dürer', work: 'Self-Portrait at 28', image: '/.netlify/functions/imgproxy?title=Albrecht_Dürer_self-portrait_1500', movement: 'Northern Renaissance', artist_prompt: 'Albrecht Dürer (German Renaissance printmaker)' },
      { artist: 'Peter Paul Rubens', work: 'The Descent from the Cross', image: '/.netlify/functions/imgproxy?title=Descent_from_the_Cross_Rubens', movement: 'Baroque', artist_prompt: 'Peter Paul Rubens (Flemish Baroque)' },
      { artist: 'Diego Velázquez', work: 'Las Meninas', image: '/.netlify/functions/imgproxy?title=Las_Meninas', movement: 'Baroque', artist_prompt: 'Diego Velázquez (Spanish Baroque court painter)' },
      { artist: 'Caravaggio', work: 'The Calling of Saint Matthew', image: '/.netlify/functions/imgproxy?title=The_Calling_of_Saint_Matthew', movement: 'Baroque', artist_prompt: 'Caravaggio (Italian, dramatic chiaroscuro)' },
      { artist: 'Jacques-Louis David', work: 'The Death of Marat', image: '/.netlify/functions/imgproxy?title=The_Death_of_Marat', movement: 'Neoclassicism', artist_prompt: 'Jacques-Louis David (French Neoclassicist)' },
      { artist: 'Caspar David Friedrich', work: 'Wanderer above the Sea of Fog', image: '/.netlify/functions/imgproxy?title=Wanderer_above_the_Sea_of_Fog', movement: 'Romanticism', artist_prompt: 'Caspar David Friedrich (German Romantic)' },
      { artist: 'Winslow Homer', work: 'The Gulf Stream', image: '/.netlify/functions/imgproxy?title=The_Gulf_Stream_(painting)', movement: 'Realism', artist_prompt: 'Winslow Homer (American Realist)' },
      { artist: 'Thomas Eakins', work: 'The Gross Clinic', image: '/.netlify/functions/imgproxy?title=The_Gross_Clinic', movement: 'Realism', artist_prompt: 'Thomas Eakins (American Realist)' },
      { artist: 'Berthe Morisot', work: 'The Cradle', image: '/.netlify/functions/imgproxy?title=The_Cradle_(Morisot)', movement: 'Impressionism', artist_prompt: 'Berthe Morisot (French Impressionist, first woman)' },
      { artist: 'Mary Cassatt', work: "The Child's Bath", image: '/.netlify/functions/imgproxy?title=The_Child%27s_Bath', movement: 'Impressionism', artist_prompt: 'Mary Cassatt (American Impressionist)' },
      { artist: 'Egon Schiele', work: 'Self-Portrait with Physalis', image: '/.netlify/functions/imgproxy?title=Egon_Schiele', movement: 'Expressionism', artist_prompt: 'Egon Schiele (Austrian Expressionist)' },
      { artist: 'Wassily Kandinsky', work: 'Composition VIII', image: '/.netlify/functions/imgproxy?title=Composition_VIII_Kandinsky', movement: 'Abstract', artist_prompt: 'Wassily Kandinsky (pioneer of abstract art)' },
      { artist: 'Piet Mondrian', work: 'Broadway Boogie Woogie', image: '/.netlify/functions/imgproxy?title=Broadway_Boogie-Woogie', movement: 'De Stijl', artist_prompt: 'Piet Mondrian (Dutch, grid paintings)' },
      { artist: "Georgia O'Keeffe", work: 'Jimson Weed/White Flower No. 1', image: '/.netlify/functions/imgproxy?title=Jimson_Weed_Georgia_OKeeffe', movement: 'Modernism', artist_prompt: "Georgia O'Keeffe (American, flower & desert)" },
      { artist: 'Diego Rivera', work: 'Man at the Crossroads', image: '/.netlify/functions/imgproxy?title=Man_at_the_Crossroads_Rivera', movement: 'Social Realism', artist_prompt: 'Diego Rivera (Mexican muralist)' },
      { artist: 'René Magritte', work: 'The Son of Man', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/e/e5/The_Son_of_Man.jpg', movement: 'Surrealism', artist_prompt: 'René Magritte (apple-in-front-of-face painting)' },
      { artist: 'Jean-Michel Basquiat', work: 'Untitled (Skull)', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/3/3f/Jean-Michel_Basquiat%2C_Untitled%2C_1982.jpg', movement: 'Neo-Expressionism', artist_prompt: 'Jean-Michel Basquiat (American, 1980s Neo-Exp.)' },
      { artist: 'Banksy', work: 'Girl with Balloon', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/2/26/Girl_and_Heart_Balloon_%282002%29_by_Banksy.jpg', movement: 'Street Art', artist_prompt: 'Banksy (anonymous British street artist)' },
    ],
  },
