...
export const FLASH_DRILLS = {
  ...
  painters: {
    ...
    items: [
      ...
      { artist: 'Salvador Dalí', work: 'The Persistence of Memory', image: '/.netlify/functions/imgproxy?title=The_Persistence_of_Memory', movement: 'Surrealism', artist_prompt: 'Salvador Dalí (Spanish Surrealist)' },
      { artist: 'René Magritte', work: 'The Treachery of Images', image: '/.netlify/functions/imgproxy?title=The_Treachery_of_Images', movement: 'Surrealism', artist_prompt: 'René Magritte (Belgian Surrealist, pipe painting)' },
      { artist: 'Frida Kahlo', work: 'The Two Fridas', image: '/.netlify/functions/imgproxy?title=The_Two_Fridas', movement: 'Surrealism', artist_prompt: 'Frida Kahlo (Mexican, self-portraits)' },
      ...
      { artist: 'Mark Rothko', work: 'Orange and Yellow', image: '/.netlify/functions/imgproxy?title=Orange_and_Yellow_Rothko', movement: 'Abstract Expressionism', artist_prompt: 'Mark Rothko (color field painting)' },
      ...
      { artist: 'Roy Lichtenstein', work: 'Whaam!', image: '/.netlify/functions/imgproxy?title=Whaam_Lichtenstein', movement: 'Pop Art', artist_prompt: 'Roy Lichtenstein (comic-style Pop Art)' },
      ...
      { artist: 'René Magritte', work: 'The Son of Man', image: '/.netlify/functions/imgproxy?title=The_Son_of_Man_Magritte', movement: 'Surrealism', artist_prompt: 'René Magritte (apple-in-front-of-face painting)' },
      { artist: 'Jean-Michel Basquiat', work: 'Untitled (Skull)', image: '/.netlify/functions/imgproxy?title=Untitled_skull_Basquiat', movement: 'Neo-Expressionism', artist_prompt: 'Jean-Michel Basquiat (American, 1980s Neo-Exp.)' },
      { artist: 'Banksy', work: 'Girl with Balloon', image: '/.netlify/functions/imgproxy?title=Girl_with_Balloon_Banksy', movement: 'Street Art', artist_prompt: 'Banksy (anonymous British street artist)' },
    ],
  },
