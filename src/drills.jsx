...
export const FLASH_DRILLS = {
  ...
  painters: {
    ...
    items: [
      { artist: 'Leonardo da Vinci', work: 'Mona Lisa', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg/200px-Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg', movement: 'Renaissance', artist_prompt: 'Leonardo da Vinci (Italian Renaissance)' },
      { artist: 'Leonardo da Vinci', work: 'The Last Supper', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/%22The_Last_Supper%22_by_Leonardo_da_Vinci%2C_High_Resolution_32x16.jpg/320px-%22The_Last_Supper%22_by_Leonardo_da_Vinci%2C_High_Resolution_32x16.jpg', movement: 'Renaissance', artist_prompt: 'Leonardo da Vinci (Mona Lisa painter)' },
      { artist: 'Michelangelo', work: 'The Creation of Adam', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Michelangelo_-_Creation_of_Adam_%28cropped%29.jpg/320px-Michelangelo_-_Creation_of_Adam_%28cropped%29.jpg', movement: 'Renaissance', artist_prompt: 'Michelangelo (Sistine Chapel ceiling)' },
      { artist: 'Raphael', work: 'The School of Athens', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/%22The_School_of_Athens%22_by_Raffaello_Sanzio_da_Urbino.jpg/320px-%22The_School_of_Athens%22_by_Raffaello_Sanzio_da_Urbino.jpg', movement: 'Renaissance', artist_prompt: 'Raphael (Italian High Renaissance)' },
      { artist: 'Sandro Botticelli', work: 'The Birth of Venus', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Sandro_Botticelli_046.jpg/320px-Sandro_Botticelli_046.jpg', movement: 'Renaissance', artist_prompt: 'Sandro Botticelli (Italian Renaissance)' },
      { artist: 'Rembrandt', work: 'The Night Watch', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/De_Nachtwacht_van_Rembrandt.jpg/320px-De_Nachtwacht_van_Rembrandt.jpg', movement: 'Dutch Golden Age', artist_prompt: 'Rembrandt van Rijn (Dutch master)' },
      { artist: 'Johannes Vermeer', work: 'Girl with a Pearl Earring', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/1665_Girl_with_a_Pearl_Earring.jpg/200px-1665_Girl_with_a_Pearl_Earring.jpg', movement: 'Dutch Golden Age', artist_prompt: 'Johannes Vermeer (Dutch, 17th c.)' },
      { artist: 'Francisco Goya', work: 'The Third of May 1808', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/El_Tres_de_Mayo%2C_by_Francisco_de_Goya%2C_from_Prado_thin_black_margin.jpg/320px-El_Tres_de_Mayo%2C_by_Francisco_de_Goya%2C_from_Prado_thin_black_margin.jpg', movement: 'Romanticism', artist_prompt: 'Francisco Goya (Spanish, late 18th c.)' },
      ...
      { artist: 'J.M.W. Turner', work: 'The Fighting Temeraire', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/The_Fighting_Temeraire%2C_JMW_Turner%2C_National_Gallery.jpg/320px-The_Fighting_Temeraire%2C_JMW_Turner%2C_National_Gallery.jpg', movement: 'Romanticism', artist_prompt: 'J.M.W. Turner (English landscape painter)' },
      { artist: 'Claude Monet', work: 'Water Lilies', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Claude_Monet_-_Water_Lilies_-_1906%2C_Ryerson.jpg/320px-Claude_Monet_-_Water_Lilies_-_1906%2C_Ryerson.jpg', movement: 'Impressionism', artist_prompt: 'Claude Monet (French Impressionist)' },
      { artist: 'Claude Monet', work: 'Impression, Sunrise', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Monet_-_Impression%2C_Sunrise.jpg/320px-Monet_-_Impression%2C_Sunrise.jpg', movement: 'Impressionism', artist_prompt: 'Claude Monet (Water Lilies painter)' },
      ...
      { artist: 'Edgar Degas', work: 'The Dance Class', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Degas_-_The_Dance_Class.jpg/240px-Degas_-_The_Dance_Class.jpg', movement: 'Impressionism', artist_prompt: 'Edgar Degas (French, ballet paintings)' },
      { artist: 'Georges Seurat', work: 'A Sunday on La Grande Jatte', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/A_Sunday_on_La_Grande_Jatte%2C_Georges_Seurat%2C_1884.jpg/320px-A_Sunday_on_La_Grande_Jatte%2C_Georges_Seurat%2C_1884.jpg', movement: 'Post-Impressionism', artist_prompt: 'Georges Seurat (Pointillism founder)' },
      { artist: 'Paul Cézanne', work: 'The Card Players', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Paul_C%C3%A9zanne%2C_The_Card_Players%2C_1892-95.jpg/320px-Paul_C%C3%A9zanne%2C_The_Card_Players%2C_1892-95.jpg', movement: 'Post-Impressionism', artist_prompt: 'Paul Cézanne (father of modern art)' },
      { artist: 'Paul Gauguin', work: 'Where Do We Come From?', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Paul_Gauguin_-_D%27ou_venons-nous.jpg/320px-Paul_Gauguin_-_D%27ou_venons-nous.jpg', movement: 'Post-Impressionism', artist_prompt: 'Paul Gauguin (Tahitian paintings)' },
      ...
      { artist: 'Gustav Klimt', work: 'The Kiss', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/The_Kiss_-_Gustav_Klimt_-_Google_Cultural_Institute.jpg/200px-The_Kiss_-_Gustav_Klimt_-_Google_Cultural_Institute.jpg', movement: 'Symbolism', artist_prompt: 'Gustav Klimt (Austrian, golden style)' },
      { artist: 'Pablo Picasso', work: 'Guernica', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/7/74/PicassoGuernica.jpg/320px-PicassoGuernica.jpg', movement: 'Cubism', artist_prompt: 'Pablo Picasso (Spanish, co-founder of Cubism)' },
      { artist: 'Pablo Picasso', work: 'Les Demoiselles d\'Avignon', movement: 'Cubism', artist_prompt: 'Pablo Picasso (Guernica painter)' },
      { artist: 'Henri Matisse', work: 'Dance', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Matissedance.jpg/320px-Matissedance.jpg', movement: 'Fauvism', artist_prompt: 'Henri Matisse (French, bold color)' },
      { artist: 'Salvador Dalí', work: 'The Persistence of Memory', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/d/dd/The_Persistence_of_Memory.jpg/320px-The_Persistence_of_Memory.jpg', movement: 'Surrealism', artist_prompt: 'Salvador Dalí (Spanish Surrealist)' },
      { artist: 'René Magritte', work: 'The Treachery of Images', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/b/b9/MagrittePipe.jpg/320px-MagrittePipe.jpg', movement: 'Surrealism', artist_prompt: 'René Magritte (Belgian Surrealist, pipe painting)' },
      { artist: 'Frida Kahlo', work: 'The Two Fridas', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/1/18/Frida_Kahlo_%28self_portrait%29.jpg/200px-Frida_Kahlo_%28self_portrait%29.jpg', movement: 'Surrealism', artist_prompt: 'Frida Kahlo (Mexican, self-portraits)' },
      { artist: 'Jackson Pollock', work: 'No. 31', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/2/2e/One31.jpg/320px-One31.jpg', movement: 'Abstract Expressionism', artist_prompt: 'Jackson Pollock (drip painting technique)' },
      { artist: 'Mark Rothko', work: 'Orange and Yellow', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/2/25/Rothko_No_61.jpg/200px-Rothko_No_61.jpg', movement: 'Abstract Expressionism', artist_prompt: 'Mark Rothko (color field painting)' },
      { artist: 'Andy Warhol', work: 'Campbell\'s Soup Cans', movement: 'Pop Art', artist_prompt: 'Andy Warhol (American Pop Art)' },
      { artist: 'Roy Lichtenstein', work: 'Whaam!', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Roy_Lichtenstein_Whaam.jpg/320px-Roy_Lichtenstein_Whaam.jpg', movement: 'Pop Art', artist_prompt: 'Roy Lichtenstein (comic-style Pop Art)' },
      { artist: 'Grant Wood', work: 'American Gothic', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Grant_DeVolson_Wood_-_American_Gothic.jpg/200px-Grant_DeVolson_Wood_-_American_Gothic.jpg', movement: 'Regionalism', artist_prompt: 'Grant Wood (American Regionalism)' },
      { artist: 'Edward Hopper', work: 'Nighthawks', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Edward_Hopper_Nighthawks_1942.jpg/320px-Edward_Hopper_Nighthawks_1942.jpg', movement: 'Realism', artist_prompt: 'Edward Hopper (American Realist)' },
      { artist: 'Jan van Eyck', work: 'The Arnolfini Portrait', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Van_Eyck_-_Arnolfini_Portrait.jpg/200px-Van_Eyck_-_Arnolfini_Portrait.jpg', movement: 'Northern Renaissance', artist_prompt: 'Jan van Eyck (Flemish, early Northern Renaissance)' },
      { artist: 'Hieronymus Bosch', work: 'The Garden of Earthly Delights', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/The_Garden_of_earthly_delights.jpg/200px-The_Garden_of_earthly_delights.jpg', movement: 'Northern Renaissance', artist_prompt: 'Hieronymus Bosch (Dutch, fantastical imagery)' },
      { artist: 'Pieter Bruegel the Elder', work: 'The Hunters in the Snow', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Pieter_Bruegel_the_Elder_-_The_Hunters_in_the_Snow_%28Winter%29_-_Google_Art_Project.jpg/320px-Pieter_Bruegel_the_Elder_-_The_Hunters_in_the_Snow_%28Winter%29_-_Google_Art_Project.jpg', movement: 'Northern Renaissance', artist_prompt: 'Bruegel the Elder (Flemish, peasant scenes)' },
      ...
      { artist: 'Peter Paul Rubens', work: 'The Descent from the Cross', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Rubens_The_Descent_from_the_Cross.jpg/200px-Rubens_The_Descent_from_the_Cross.jpg', movement: 'Baroque', artist_prompt: 'Peter Paul Rubens (Flemish Baroque)' },
      { artist: 'Diego Velázquez', work: 'Las Meninas', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Las_Meninas_01.jpg/200px-Las_Meninas_01.jpg', movement: 'Baroque', artist_prompt: 'Diego Velázquez (Spanish Baroque court painter)' },
      { artist: 'Caravaggio', work: 'The Calling of Saint Matthew', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Caravaggio_-_La_vocazione_di_san_Matteo.jpg/240px-Caravaggio_-_La_vocazione_di_san_Matteo.jpg', movement: 'Baroque', artist_prompt: 'Caravaggio (Italian, dramatic chiaroscuro)' },
      { artist: 'Jacques-Louis David', work: 'The Death of Marat', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Death_of_Marat_by_David.jpg/200px-Death_of_Marat_by_David.jpg', movement: 'Neoclassicism', artist_prompt: 'Jacques-Louis David (French Neoclassicist)' },
      { artist: 'Caspar David Friedrich', work: 'Wanderer above the Sea of Fog', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Caspar_David_Friedrich_-_Wanderer_above_the_sea_of_fog.jpg/200px-Caspar_David_Friedrich_-_Wanderer_above_the_sea_of_fog.jpg', movement: 'Romanticism', artist_prompt: 'Caspar David Friedrich (German Romantic)' },
      ...
      { artist: 'Wassily Kandinsky', work: 'Composition VIII', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Vassily_Kandinsky%2C_1923_-_Composition_8%2C_huile_sur_toile%2C_140_cm_x_201_cm%2C_Muse%CC%81e_Guggenheim%2C_New_York.jpg/320px-Vassily_Kandinsky%2C_1923_-_Composition_8%2C_huile_sur_toile%2C_140_cm_x_201_cm%2C_Muse%CC%81e_Guggenheim%2C_New_York.jpg', movement: 'Abstract', artist_prompt: 'Wassily Kandinsky (pioneer of abstract art)' },
      { artist: 'Piet Mondrian', work: 'Broadway Boogie Woogie', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Piet_Mondriaan%2C_1942_-_Broadway_Boogie-Woogie.jpg/200px-Piet_Mondriaan%2C_1942_-_Broadway_Boogie-Woogie.jpg', movement: 'De Stijl', artist_prompt: 'Piet Mondrian (Dutch, grid paintings)' },
