...
export const FLASH_DRILLS = {
  ...
  painters: {
    ...
    items: [
      ...
      { artist: 'Edgar Degas', work: 'The Dance Class', image: '/.netlify/functions/imgproxy?title=The_Dance_Class_(Degas,_Musée_d%27Orsay)', movement: 'Impressionism', artist_prompt: 'Edgar Degas (French, ballet paintings)' },
      ...
      { artist: 'Mark Rothko', work: 'Orange and Yellow', image: '/.netlify/functions/imgproxy?title=Orange_and_Yellow', movement: 'Abstract Expressionism', artist_prompt: 'Mark Rothko (color field painting)' },
      { artist: 'Andy Warhol', work: 'Campbell\'s Soup Cans', movement: 'Pop Art', artist_prompt: 'Andy Warhol (American Pop Art)' },
      { artist: 'Roy Lichtenstein', work: 'Whaam!', image: '/.netlify/functions/imgproxy?title=Whaam!', movement: 'Pop Art', artist_prompt: 'Roy Lichtenstein (comic-style Pop Art)' },
      ...
      { artist: 'Edward Hopper', work: 'Nighthawks', image: '/.netlify/functions/imgproxy?title=Nighthawks_(painting)', movement: 'Realism', artist_prompt: 'Edward Hopper (American Realist)' },
      ...
      { artist: 'Albrecht Dürer', work: 'Self-Portrait at 28', image: '/.netlify/functions/imgproxy?title=Self-portrait_(Dürer,_Munich)', movement: 'Northern Renaissance', artist_prompt: 'Albrecht Dürer (German Renaissance printmaker)' },
      { artist: 'Peter Paul Rubens', work: 'The Descent from the Cross', image: '/.netlify/functions/imgproxy?title=The_Descent_from_the_Cross_(Rubens,_Antwerp)', movement: 'Baroque', artist_prompt: 'Peter Paul Rubens (Flemish Baroque)' },
      ...
      { artist: 'Wassily Kandinsky', work: 'Composition VIII', image: '/.netlify/functions/imgproxy?title=Composition_VIII', movement: 'Abstract', artist_prompt: 'Wassily Kandinsky (pioneer of abstract art)' },
      ...
      { artist: 'René Magritte', work: 'The Son of Man', image: '/.netlify/functions/imgproxy?title=The_Son_of_Man', movement: 'Surrealism', artist_prompt: 'René Magritte (apple-in-front-of-face painting)' },
      ...
      { artist: 'Banksy', work: 'Girl with Balloon', image: '/.netlify/functions/imgproxy?title=Girl_with_Balloon', movement: 'Street Art', artist_prompt: 'Banksy (anonymous British street artist)' },
    ],
  },
