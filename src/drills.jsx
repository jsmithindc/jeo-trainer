...
export const FLASH_DRILLS = {
  ...
  painters: {
    ...
    items: [
      ...
      { artist: 'Claude Monet', work: 'Water Lilies', image: '/.netlify/functions/imgproxy?title=Water_Lilies_(Monet_series)', movement: 'Impressionism', artist_prompt: 'Claude Monet (French Impressionist)' },
      ...
      { artist: 'Edgar Degas', work: 'The Dance Class', image: '/.netlify/functions/imgproxy?title=The_Dance_Class_(Degas)', movement: 'Impressionism', artist_prompt: 'Edgar Degas (French, ballet paintings)' },
      { artist: 'Georges Seurat', work: 'A Sunday on La Grande Jatte', image: '/.netlify/functions/imgproxy?title=A_Sunday_on_La_Grande_Jatte_(Seurat)', movement: 'Post-Impressionism', artist_prompt: 'Georges Seurat (Pointillism founder)' },
      { artist: 'Paul Cézanne', work: 'The Card Players', image: '/.netlify/functions/imgproxy?title=The_Card_Players', movement: 'Post-Impressionism', artist_prompt: 'Paul Cézanne (father of modern art)' },
      { artist: 'Paul Gauguin', work: 'Where Do We Come From?', image: '/.netlify/functions/imgproxy?title=Where_Do_We_Come_From?_What_Are_We?_Where_Are_We_Going?', movement: 'Post-Impressionism', artist_prompt: 'Paul Gauguin (Tahitian paintings)' },
      ...
      { artist: 'Vincent van Gogh', work: 'Sunflowers', image: '/.netlify/functions/imgproxy?title=Sunflowers_(Van_Gogh_series)', movement: 'Post-Impressionism', artist_prompt: 'Vincent van Gogh (The Starry Night painter)' },
      ...
      { artist: 'Salvador Dalí', work: 'The Persistence of Memory', image: '/.netlify/functions/imgproxy?title=The_Persistence_of_Memory_(Dalí)', movement: 'Surrealism', artist_prompt: 'Salvador Dalí (Spanish Surrealist)' },
      { artist: 'René Magritte', work: 'The Treachery of Images', image: '/.netlify/functions/imgproxy?title=The_Treachery_of_Images_(Magritte)', movement: 'Surrealism', artist_prompt: 'René Magritte (Belgian Surrealist, pipe painting)' },
      { artist: 'Frida Kahlo', work: 'The Two Fridas', image: '/.netlify/functions/imgproxy?title=The_Two_Fridas_(Kahlo)', movement: 'Surrealism', artist_prompt: 'Frida Kahlo (Mexican, self-portraits)' },
      ...
      { artist: 'Mark Rothko', work: 'Orange and Yellow', image: '/.netlify/functions/imgproxy?title=Orange_and_Yellow_(Rothko)', movement: 'Abstract Expressionism', artist_prompt: 'Mark Rothko (color field painting)' },
      { artist: 'Andy Warhol', work: 'Campbell\'s Soup Cans', image: '/.netlify/functions/imgproxy?title=Campbell%27s_Soup_Cans', movement: 'Pop Art', artist_prompt: 'Andy Warhol (American Pop Art)' },
      { artist: 'Roy Lichtenstein', work: 'Whaam!', image: '/.netlify/functions/imgproxy?title=Whaam!_(painting)', movement: 'Pop Art', artist_prompt: 'Roy Lichtenstein (comic-style Pop Art)' },
      ...
      { artist: 'Albrecht Dürer', work: 'Self-Portrait at 28', image: '/.netlify/functions/imgproxy?title=Self-portrait_at_28_(Dürer)', movement: 'Northern Renaissance', artist_prompt: 'Albrecht Dürer (German Renaissance printmaker)' },
      { artist: 'Peter Paul Rubens', work: 'The Descent from the Cross', image: '/.netlify/functions/imgproxy?title=The_Descent_from_the_Cross_(Rubens_triptych)', movement: 'Baroque', artist_prompt: 'Peter Paul Rubens (Flemish Baroque)' },
      ...
      { artist: 'Wassily Kandinsky', work: 'Composition VIII', image: '/.netlify/functions/imgproxy?title=Composition_VIII_(Kandinsky)', movement: 'Abstract', artist_prompt: 'Wassily Kandinsky (pioneer of abstract art)' },
      { artist: 'Piet Mondrian', work: 'Broadway Boogie Woogie', image: '/.netlify/functions/imgproxy?title=Broadway_Boogie-Woogie_(Mondrian)', movement: 'De Stijl', artist_prompt: 'Piet Mondrian (Dutch, grid paintings)' },
      { artist: "Georgia O'Keeffe", work: 'Jimson Weed/White Flower No. 1', image: '/.netlify/functions/imgproxy?title=Jimson_Weed/White_Flower_No._1', movement: 'Modernism', artist_prompt: "Georgia O'Keeffe (American, flower & desert)" },
      { artist: 'Diego Rivera', work: 'Man at the Crossroads', image: '/.netlify/functions/imgproxy?title=Man_at_the_Crossroads', movement: 'Social Realism', artist_prompt: 'Diego Rivera (Mexican muralist)' },
      { artist: 'René Magritte', work: 'The Son of Man', image: '/.netlify/functions/imgproxy?title=The_Son_of_Man_(Magritte)', movement: 'Surrealism', artist_prompt: 'René Magritte (apple-in-front-of-face painting)' },
      { artist: 'Jean-Michel Basquiat', work: 'Untitled (Skull)', image: '/.netlify/functions/imgproxy?title=Jean-Michel_Basquiat', movement: 'Neo-Expressionism', artist_prompt: 'Jean-Michel Basquiat (American, 1980s Neo-Exp.)' },
      { artist: 'Banksy', work: 'Girl with Balloon', image: '/.netlify/functions/imgproxy?title=Girl_with_Balloon_(Banksy)', movement: 'Street Art', artist_prompt: 'Banksy (anonymous British street artist)' },
    ],
  },
