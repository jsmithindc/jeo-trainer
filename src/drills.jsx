...
export const FLASH_DRILLS = {
  ...
  painters: {
    ...
    items: [
      { artist: 'Leonardo da Vinci', work: 'Mona Lisa', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg/330px-Mona_Lisa%2C_by_Leonardo_da_Vinci%2C_from_C2RMF_retouched.jpg', movement: 'Renaissance', artist_prompt: 'Leonardo da Vinci (Italian Renaissance)' },
      { artist: 'Leonardo da Vinci', work: 'The Last Supper', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/%22The_Last_Supper%22_by_Leonardo_da_Vinci%2C_High_Resolution_32x16.jpg/330px-%22The_Last_Supper%22_by_Leonardo_da_Vinci%2C_High_Resolution_32x16.jpg', movement: 'Renaissance', artist_prompt: 'Leonardo da Vinci (Mona Lisa painter)' },
      { artist: 'Michelangelo', work: 'The Creation of Adam', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Michelangelo_-_Creation_of_Adam_%28cropped%29.jpg/330px-Michelangelo_-_Creation_of_Adam_%28cropped%29.jpg', movement: 'Renaissance', artist_prompt: 'Michelangelo (Sistine Chapel ceiling)' },
      { artist: 'Raphael', work: 'The School of Athens', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/%22The_School_of_Athens%22_by_Raffaello_Sanzio_da_Urbino.jpg/330px-%22The_School_of_Athens%22_by_Raffaello_Sanzio_da_Urbino.jpg', movement: 'Renaissance', artist_prompt: 'Raphael (Italian High Renaissance)' },
      { artist: 'Sandro Botticelli', work: 'The Birth of Venus', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Sandro_Botticelli_046.jpg/330px-Sandro_Botticelli_046.jpg', movement: 'Renaissance', artist_prompt: 'Sandro Botticelli (Italian Renaissance)' },
      { artist: 'Rembrandt', work: 'The Night Watch', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/De_Nachtwacht_van_Rembrandt.jpg/330px-De_Nachtwacht_van_Rembrandt.jpg', movement: 'Dutch Golden Age', artist_prompt: 'Rembrandt van Rijn (Dutch master)' },
      { artist: 'Johannes Vermeer', work: 'Girl with a Pearl Earring', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/1665_Girl_with_a_Pearl_Earring.jpg/330px-1665_Girl_with_a_Pearl_Earring.jpg', movement: 'Dutch Golden Age', artist_prompt: 'Johannes Vermeer (Dutch, 17th c.)' },
      { artist: 'Francisco Goya', work: 'The Third of May 1808', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/f/fd/El_Tres_de_Mayo%2C_by_Francisco_de_Goya%2C_from_Prado_thin_black_margin.jpg/330px-El_Tres_de_Mayo%2C_by_Francisco_de_Goya%2C_from_Prado_thin_black_margin.jpg', movement: 'Romanticism', artist_prompt: 'Francisco Goya (Spanish, late 18th c.)' },
      { artist: 'Eugène Delacroix', work: 'Liberty Leading the People', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/Eug%C3%A8ne_Delacroix_-_La_libert%C3%A9_guidant_le_peuple.jpg/330px-Eug%C3%A8ne_Delacroix_-_La_libert%C3%A9_guidant_le_peuple.jpg', movement: 'Romanticism', artist_prompt: 'Eugène Delacroix (French Romantic)' },
      { artist: 'J.M.W. Turner', work: 'The Fighting Temeraire', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/The_Fighting_Temeraire%2C_JMW_Turner%2C_National_Gallery.jpg/330px-The_Fighting_Temeraire%2C_JMW_Turner%2C_National_Gallery.jpg', movement: 'Romanticism', artist_prompt: 'J.M.W. Turner (English landscape painter)' },
      { artist: 'Claude Monet', work: 'Water Lilies', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Claude_Monet_-_Water_Lilies_-_1906%2C_Ryerson.jpg/330px-Claude_Monet_-_Water_Lilies_-_1906%2C_Ryerson.jpg', movement: 'Impressionism', artist_prompt: 'Claude Monet (French Impressionist)' },
      { artist: 'Claude Monet', work: 'Impression, Sunrise', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/Monet_-_Impression%2C_Sunrise.jpg/330px-Monet_-_Impression%2C_Sunrise.jpg', movement: 'Impressionism', artist_prompt: 'Claude Monet (Water Lilies painter)' },
      { artist: 'Pierre-Auguste Renoir', work: 'Luncheon of the Boating Party', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/8/8d/Pierre-Auguste_Renoir_-_Luncheon_of_the_Boating_Party_-_Google_Art_Project.jpg/330px-Pierre-Auguste_Renoir_-_Luncheon_of_the_Boating_Party_-_Google_Art_Project.jpg', movement: 'Impressionism', artist_prompt: 'Pierre-Auguste Renoir (French Impressionist)' },
      { artist: 'Edgar Degas', work: 'The Dance Class', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Degas_-_The_Dance_Class.jpg/330px-Degas_-_The_Dance_Class.jpg', movement: 'Impressionism', artist_prompt: 'Edgar Degas (French, ballet paintings)' },
      { artist: 'Georges Seurat', work: 'A Sunday on La Grande Jatte', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/A_Sunday_on_La_Grande_Jatte%2C_Georges_Seurat%2C_1884.jpg/330px-A_Sunday_on_La_Grande_Jatte%2C_Georges_Seurat%2C_1884.jpg', movement: 'Post-Impressionism', artist_prompt: 'Georges Seurat (Pointillism founder)' },
      { artist: 'Paul Cézanne', work: 'The Card Players', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Paul_C%C3%A9zanne%2C_The_Card_Players%2C_1892-95.jpg/330px-Paul_C%C3%A9zanne%2C_The_Card_Players%2C_1892-95.jpg', movement: 'Post-Impressionism', artist_prompt: 'Paul Cézanne (father of modern art)' },
      { artist: 'Paul Gauguin', work: 'Where Do We Come From?', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/7/71/Paul_Gauguin_-_D%27ou_venons-nous.jpg/330px-Paul_Gauguin_-_D%27ou_venons-nous.jpg', movement: 'Post-Impressionism', artist_prompt: 'Paul Gauguin (Tahitian paintings)' },
      { artist: 'Vincent van Gogh', work: 'The Starry Night', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg/330px-Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg', movement: 'Post-Impressionism', artist_prompt: 'Vincent van Gogh (Dutch Post-Impressionist)' },
      { artist: 'Vincent van Gogh', work: 'Sunflowers', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Vincent_van_Gogh_-_Sunflowers_%281888%2C_National_Gallery_London%29.jpg/330px-Vincent_van_Gogh_-_Sunflowers_%281888%2C_National_Gallery_London%29.jpg', movement: 'Post-Impressionism', artist_prompt: 'Vincent van Gogh (The Starry Night painter)' },
      { artist: 'Edvard Munch', work: 'The Scream', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Edvard_Munch%2C_1893%2C_The_Scream%2C_oil%2C_tempera_and_pastel_on_cardboard%2C_91_x_73_cm%2C_National_Gallery_of_Norway.jpg/330px-Edvard_Munch%2C_1893%2C_The_Scream%2C_oil%2C_tempera_and_pastel_on_cardboard%2C_91_x_73_cm%2C_National_Gallery_of_Norway.jpg', movement: 'Expressionism', artist_prompt: 'Edvard Munch (Norwegian Expressionist)' },
      { artist: 'Gustav Klimt', work: 'The Kiss', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/The_Kiss_-_Gustav_Klimt_-_Google_Cultural_Institute.jpg/330px-The_Kiss_-_Gustav_Klimt_-_Google_Cultural_Institute.jpg', movement: 'Symbolism', artist_prompt: 'Gustav Klimt (Austrian, golden style)' },
      { artist: 'Pablo Picasso', work: 'Guernica', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/7/74/PicassoGuernica.jpg/330px-PicassoGuernica.jpg', movement: 'Cubism', artist_prompt: 'Pablo Picasso (Spanish, co-founder of Cubism)' },
      { artist: 'Pablo Picasso', work: 'Les Demoiselles d\'Avignon', movement: 'Cubism', artist_prompt: 'Pablo Picasso (Guernica painter)' },
      { artist: 'Henri Matisse', work: 'Dance', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Matissedance.jpg/330px-Matissedance.jpg', movement: 'Fauvism', artist_prompt: 'Henri Matisse (French, bold color)' },
      { artist: 'Salvador Dalí', work: 'The Persistence of Memory', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/d/dd/The_Persistence_of_Memory.jpg/330px-The_Persistence_of_Memory.jpg', movement: 'Surrealism', artist_prompt: 'Salvador Dalí (Spanish Surrealist)' },
      { artist: 'René Magritte', work: 'The Treachery of Images', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/b/b9/MagrittePipe.jpg/330px-MagrittePipe.jpg', movement: 'Surrealism', artist_prompt: 'René Magritte (Belgian Surrealist, pipe painting)' },
      { artist: 'Frida Kahlo', work: 'The Two Fridas', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/1/18/Frida_Kahlo_%28self_portrait%29.jpg/330px-Frida_Kahlo_%28self_portrait%29.jpg', movement: 'Surrealism', artist_prompt: 'Frida Kahlo (Mexican, self-portraits)' },
      { artist: 'Jackson Pollock', work: 'No. 31', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/2/2e/One31.jpg/330px-One31.jpg', movement: 'Abstract Expressionism', artist_prompt: 'Jackson Pollock (drip painting technique)' },
      { artist: 'Mark Rothko', work: 'Orange and Yellow', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/2/25/Rothko_No_61.jpg/330px-Rothko_No_61.jpg', movement: 'Abstract Expressionism', artist_prompt: 'Mark Rothko (color field painting)' },
      { artist: 'Andy Warhol', work: 'Campbell\'s Soup Cans', movement: 'Pop Art', artist_prompt: 'Andy Warhol (American Pop Art)' },
      { artist: 'Roy Lichtenstein', work: 'Whaam!', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Roy_Lichtenstein_Whaam.jpg/330px-Roy_Lichtenstein_Whaam.jpg', movement: 'Pop Art', artist_prompt: 'Roy Lichtenstein (comic-style Pop Art)' },
      { artist: 'Grant Wood', work: 'American Gothic', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/c/cc/Grant_DeVolson_Wood_-_American_Gothic.jpg/330px-Grant_DeVolson_Wood_-_American_Gothic.jpg', movement: 'Regionalism', artist_prompt: 'Grant Wood (American Regionalism)' },
      { artist: 'Edward Hopper', work: 'Nighthawks', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Edward_Hopper_Nighthawks_1942.jpg/330px-Edward_Hopper_Nighthawks_1942.jpg', movement: 'Realism', artist_prompt: 'Edward Hopper (American Realist)' },
      { artist: 'Jan van Eyck', work: 'The Arnolfini Portrait', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Van_Eyck_-_Arnolfini_Portrait.jpg/330px-Van_Eyck_-_Arnolfini_Portrait.jpg', movement: 'Northern Renaissance', artist_prompt: 'Jan van Eyck (Flemish, early Northern Renaissance)' },
      { artist: 'Hieronymus Bosch', work: 'The Garden of Earthly Delights', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/The_Garden_of_earthly_delights.jpg/330px-The_Garden_of_earthly_delights.jpg', movement: 'Northern Renaissance', artist_prompt: 'Hieronymus Bosch (Dutch, fantastical imagery)' },
      { artist: 'Pieter Bruegel the Elder', work: 'The Hunters in the Snow', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Pieter_Bruegel_the_Elder_-_The_Hunters_in_the_Snow_%28Winter%29_-_Google_Art_Project.jpg/330px-Pieter_Bruegel_the_Elder_-_The_Hunters_in_the_Snow_%28Winter%29_-_Google_Art_Project.jpg', movement: 'Northern Renaissance', artist_prompt: 'Bruegel the Elder (Flemish, peasant scenes)' },
      { artist: 'Albrecht Dürer', work: 'Self-Portrait at 28', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Albrecht_D%C3%BCrer_-_1500_self-portrait_%28High_resolution_and_detail%29.jpg/330px-Albrecht_D%C3%BCrer_-_1500_self-portrait_%28High_resolution_and_detail%29.jpg', movement: 'Northern Renaissance', artist_prompt: 'Albrecht Dürer (German Renaissance printmaker)' },
      { artist: 'Peter Paul Rubens', work: 'The Descent from the Cross', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Rubens_The_Descent_from_the_Cross.jpg/330px-Rubens_The_Descent_from_the_Cross.jpg', movement: 'Baroque', artist_prompt: 'Peter Paul Rubens (Flemish Baroque)' },
      { artist: 'Diego Velázquez', work: 'Las Meninas', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Las_Meninas_01.jpg/330px-Las_Meninas_01.jpg', movement: 'Baroque', artist_prompt: 'Diego Velázquez (Spanish Baroque court painter)' },
      { artist: 'Caravaggio', work: 'The Calling of Saint Matthew', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Caravaggio_-_La_vocazione_di_san_Matteo.jpg/330px-Caravaggio_-_La_vocazione_di_san_Matteo.jpg', movement: 'Baroque', artist_prompt: 'Caravaggio (Italian, dramatic chiaroscuro)' },
      { artist: 'Jacques-Louis David', work: 'The Death of Marat', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Death_of_Marat_by_David.jpg/330px-Death_of_Marat_by_David.jpg', movement: 'Neoclassicism', artist_prompt: 'Jacques-Louis David (French Neoclassicist)' },
      { artist: 'Caspar David Friedrich', work: 'Wanderer above the Sea of Fog', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Caspar_David_Friedrich_-_Wanderer_above_the_sea_of_fog.jpg/330px-Caspar_David_Friedrich_-_Wanderer_above_the_sea_of_fog.jpg', movement: 'Romanticism', artist_prompt: 'Caspar David Friedrich (German Romantic)' },
      ...
      { artist: 'Wassily Kandinsky', work: 'Composition VIII', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Vassily_Kandinsky%2C_1923_-_Composition_8%2C_huile_sur_toile%2C_140_cm_x_201_cm%2C_Muse%CC%81e_Guggenheim%2C_New_York.jpg/330px-Vassily_Kandinsky%2C_1923_-_Composition_8%2C_huile_sur_toile%2C_140_cm_x_201_cm%2C_Muse%CC%81e_Guggenheim%2C_New_York.jpg', movement: 'Abstract', artist_prompt: 'Wassily Kandinsky (pioneer of abstract art)' },
      { artist: 'Piet Mondrian', work: 'Broadway Boogie Woogie', image: '/.netlify/functions/imgproxy?url=https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Piet_Mondriaan%2C_1942_-_Broadway_Boogie-Woogie.jpg/330px-Piet_Mondriaan%2C_1942_-_Broadway_Boogie-Woogie.jpg', movement: 'De Stijl', artist_prompt: 'Piet Mondrian (Dutch, grid paintings)' },
